...
(
    ...
    CREATED_DATE         TIMESTAMP DEFAULT (GETUTCDATE()),
    STATUS_ID            VARCHAR(10) DEFAULT 'Active',
    DATAATTRIBUTE_ID     CHAR(38),
...
(
	DATACRAWLER_ID ASC, TOKEN ASC,CREATED_DATE ASC, STATUS_ID ASC,
...
(
    ...
    SUPPORTINGVALUE7 ASC, CREATED_DATE ASC, STATUS_ID ASC, DATAATTRIBUTE_ID ASC,
...
(
    DATASTRUCTURE_CORE_ID ASC, DATASTRUCTURE_NAME ASC, CREATED_DATE ASC,
...
(
 DATATOKEN_ID ASC, TOKEN ASC, CREATED_DATE ASC, STATUS_ID ASC,
...
(
    TERMCODESET_ID ASC, CREATED_DATE ASC, STATUS_ID ASC, CUI ASC, LAT ASC,
...
CREATE INDEX PLATFORM_CODESETS_INDUSTRYSTDS_INDX ON PLATFORM_CODESETS_INDUSTRYSTDS
( TERMCODESET_ID ASC, CREATED_DATE ASC, STATUS_ID ASC, SCUI ASC,
