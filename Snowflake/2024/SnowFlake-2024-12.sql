...
(
    ...
    MAINTAINED_DATE TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
...
(
    ...
    APINAME            TEXT,
    MAINTAINED_DATE       TEXT DEFAULT (DATETIME('NOW', 'LOCALTIME')),
    STATUS_ID          VARCHAR(10),
    PURPOSE            TEXT,
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_UINDEX
    ON DATATIER_SDP_DATAATTRIBUTES (DATATIER_ID, BASEVALUE, SUPPORTINGVALUE1, SUPPORTINGVALUE2, SUPPORTINGVALUE3, SUPPORTINGVALUE4,
                                    SUPPORTINGVALUE5, SUPPORTINGVALUE6, SUPPORTINGVALUE7, MAINTAINED_DATE, DATAATTRIBUTE_ID,
