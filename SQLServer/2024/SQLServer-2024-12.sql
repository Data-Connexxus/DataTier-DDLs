...
(
    REFDATA_DATASTRUCTURES_DTL_ID CHAR(38)    DEFAULT NEWID() NOT NULL PRIMARY KEY,
...
CREATE TABLE DATATIER_SDP_DATAATTRIBUTES_METADATA
(
    SDP_DATAATTRIBUTE_METADATA_ID INT IDENTITY(1,1) PRIMARY KEY,
    DATAATTRIBUTE_PARAM           VARCHAR(99),
    DATAATTRIBUTE_VALUE           VARCHAR(169),
    MAINTAINED_DATE               DATETIME    DEFAULT (GETUTCDATE()),
    STATUS_ID                     VARCHAR(10) DEFAULT 'Active',
    DATAATTRIBUTE_ID              CHAR(38),
    CREATED_USER                  VARCHAR(20) DEFAULT 'Plaform',
...
(
    DATABUILD_DATAATTRIBUTE_DTL_ID CHAR(38)    DEFAULT NEWID() NOT NULL PRIMARY KEY,
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_INDEX ON DATATIER_SDP_DATAATTRIBUTES
    (
     DATATIER_ID, BASEVALUE, SUPPORTINGVALUE1, SUPPORTINGVALUE2, SUPPORTINGVALUE3, SUPPORTINGVALUE4,
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_INDX ON DATATIER_SDP_DATAATTRIBUTES
    (
     DATATIER_ID ASC, BASEVALUE ASC, SUPPORTINGVALUE1 ASC, SUPPORTINGVALUE2 ASC,
     SUPPORTINGVALUE3 ASC, SUPPORTINGVALUE4 ASC, SUPPORTINGVALUE5 ASC, SUPPORTINGVALUE6 ASC,
     SUPPORTINGVALUE7 ASC, MAINTAINED_DATE ASC, STATUS_ID ASC, DATAATTRIBUTE_ID ASC,
     CREATED_USER ASC, REGISTEREDAPP_GUID ASC, DATAGENTYPE_ID ASC
        );
