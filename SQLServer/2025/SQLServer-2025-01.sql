...
(
    ...
    MAINTAINED_DATE        DATETIME    DEFAULT (GETUTCDATE()),
...
(
    ...
    STATUS_ID          VARCHAR(10)   DEFAULT 'Active',
    MAINTAINED_DATE       VARCHAR(20)   DEFAULT (GETUTCDATE()),
    MAINTAINED_USER       VARCHAR(20)   DEFAULT 'Platform',
...
(
    REFDATA_DATASTRUCTURES_DTL_ID CHAR(38)    DEFAULT NEWID() NOT NULL,
    REFDATA_DATASTRUCTURES_ID     CHAR(38),
    DATAATTRIBUTE_ID              CHAR(38),
    SENSITIVITYFLAG_ID            VARCHAR(5)  DEFAULT 'UNDF',
    MAINTAINED_DATE               DATETIME    DEFAULT (GETUTCDATE()),
    EXPIRATION_DATE               DATE        DEFAULT DATEADD(YEAR, 1, GETDATE()),
    STATUS_ID                     VARCHAR(10) DEFAULT 'Active',
    MAINTAINED_USER                  VARCHAR(20) DEFAULT 'Platform',
    PRIMARY KEY(REFDATA_DATASTRUCTURES_DTL_ID)
);
...
CREATE TABLE DATAMODEL_QUERIES
(
    DATAMODEL_QUERIES_ID INT IDENTITY(1,1),
    ...
    STATUS_ID           VARCHAR(10) DEFAULT 'Active',
    MAINTAINED_USER        VARCHAR(20) DEFAULT 'Platform'
    PRIMARY KEY(DATAMODEL_QUERIES_ID)
    );
...
(
    DATACRAWLER_ID      INT IDENTITY(1,1),
    TOKEN               CHAR(128),
...
(
    DATATIER_SDP_DATAATTRIBUTE_ID INT IDENTITY(1,1),
    DATAATTRIBUTE_ID   CHAR(38),
    DATAGENTYPE_ID     CHAR(38),
    PARAM_VALUE        VARCHAR(99),
    PARAM_VALUE_METADATA VARCHAR(159),
    MAINTAINED_DATE    DATETIME DEFAULT CURRENT_TIMESTAMP,
    STATUS_ID          VARCHAR(10) DEFAULT 'Active',
    MAINTAINED_USER       VARCHAR(20) DEFAULT 'Platform',
    REGISTEREDAPP_GUID CHAR(38),
    ORGANIZATION_GUID CHAR(38),
...
(
    TERMCODESET_ID  INT IDENTITY(1,1),
    CUI             VARCHAR(8) NULL,
    LAT             VARCHAR(3) NULL,
    TS              VARCHAR(1) NULL,
    LUI             VARCHAR(10) NULL,
    ...
    CVF             INT NULL,
    MAINTAINED_DATE TIMESTAMP   DEFAULT (GETUTCDATE()),
    EXPIRATION_DATE DATE   DEFAULT DEFAULT DATEADD(YEAR, 1, GETDATE()),
    MAINTAINED_USER VARCHAR(20) DEFAULT 'Platform',
    STATUS_ID       VARCHAR(10) DEFAULT 'Active',
...
(
    DATABUILD_DATAATTRIBUTE_DTL_ID CHAR(38)    DEFAULT NEWID() NOT NULL,
    DATABUILD_DATAATTRIBUTE_ID     CHAR(38),
    DATAATTRIBUTE_ID               CHAR(38),
    MAINTAINED_DATE                DATETIME    DEFAULT (GETUTCDATE()),
    EXPIRATION_DATE                DATE        DEFAULT DATEADD(YEAR, 1, GETDATE()),
    PARAM_NAME                     VARCHAR(30),
    PARAM_OPERATOR                 VARCHAR(10),
    PARAM_VALUE                    VARCHAR(65),
    STATUS_ID                      VARCHAR(10) DEFAULT 'Active',
    MAINTAINED_USER                   VARCHAR(20) DEFAULT 'Platform',
    PRIMARY KEY(DATABUILD_DATAATTRIBUTE_DTL_ID)
);
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_INDEX ON DATATIER_SDP_DATAATTRIBUTES
    (
     DATATIER_SDP_DATAATTRIBUTE_ID ASC,PARAM_VALUE ASC,PARAM_VALUE_METADATA ASC, MAINTAINED_DATE ASC,
     DATAATTRIBUTE_ID ASC, DATAGENTYPE_ID ASC, STATUS_ID ASC, MAINTAINED_USER ASC, REGISTEREDAPP_GUID ASC
        );

DROP INDEX IF EXISTS DATATIER_CRAWLER_INDX ON DATATIER_CRAWLERS;
CREATE INDEX DATATIER_CRAWLER_INDX ON DATATIER_CRAWLERS
    (
     DATACRAWLER_ID ASC, TOKEN ASC, MAINTAINED_DATE ASC, STATUS_ID ASC,
     REGISTEREDAPP_GUID ASC, ORGANIZATION_GUID ASC
        )
...
CREATE INDEX DATATIER_SDP_DATASTRUCTURES_INDEX ON DATATIER_SDP_DATASTRUCTURES
    (
     DATASTRUCTURE_CORE_ID ASC, DATASTRUCTURE_NAME ASC, MAINTAINED_DATE ASC,
     STATUS_ID ASC, REGISTEREDAPP_GUID ASC
        );

DROP INDEX IF EXISTS DATATIER_TOKENS_INDX ON DATATIER_TOKENS;
CREATE INDEX DATATIER_TOKENS_INDEX ON DATATIER_TOKENS
    (
     DATATOKEN_ID ASC, TOKEN ASC, MAINTAINED_DATE ASC, STATUS_ID ASC,
     REGISTEREDAPP_GUID ASC, ORGANIZATION_GUID ASC, INTFC_TYPE ASC, DATASOURCE_ID ASC
        );
...
CREATE INDEX PLATFORM_CODESETS_INDUSTRYSTDS_INDX on PLATFORM_CODESETS_INDUSTRYSTDS
    (
     TERMCODESET_ID ASC, MAINTAINED_DATE ASC, STATUS_ID ASC, CUI ASC, LAT ASC,
     TS ASC, LUI ASC, STT ASC, SUI ASC, ISPREF ASC, AUI ASC, SAUI ASC
        );

DROP INDEX IF EXISTS PLATFORM_CODESETS_INDUSTRYSTDS_INDX ON PLATFORM_CODESETS_INDUSTRYSTDS;
CREATE INDEX PLATFORM_CODESETS_INDUSTRYSTDS_INDX ON PLATFORM_CODESETS_INDUSTRYSTDS
    (
     TERMCODESET_ID ASC, MAINTAINED_DATE ASC, STATUS_ID ASC, SCUI ASC,
     SDUI ASC, SAB ASC, TTY ASC, CODE ASC, SRL ASC, SUPPRESS ASC, CVF ASC
    );