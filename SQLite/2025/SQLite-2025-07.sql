...
(
    VENDOR_ID    CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_VENDORS
BEGIN
...
(
    LEGALENTITY_GUID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_LEGALENTITIES
BEGIN
...
(
    ORGANIZATION_GUID          CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_ORGANIZATIONS
BEGIN
...
(
    APP_GUID               CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_APPLICATIONS
BEGIN
...
(
    SENSITIVITYFLAG_ID   CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_SENSITIVITYFLAGS
BEGIN
...
(
    CODESETS_ID        CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_CODESETS
BEGIN
...
(
    DATAATTRIBUTE_ID   TEXT PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    DATASTRUCTURE_ID   CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_DATASTRUCTURES
BEGIN
...
(
    REFDATA_DATASTRUCTURES_DTL_ID CHAR(38)  PRIMARY KEY  DEFAULT (UPPER(HEX(RANDOMBLOB(16)))) ,
...
(
    DEVICETYPE_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
AFTER UPDATE ON REFDATA_DEVICETYPES
BEGIN
...
(
    INDUSTRY_ID   CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    INDUSTRYTOBUSINESS_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
    INDUSTRY_ID           CHAR(38),
...
(
    PROFESSIONTYPE_ID   CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    API_ID             CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    PLATFORM_CODESET_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    CODESETCROSSMAP_ID  CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
    REGISTEREDAPP_GUID  CHAR(38),
    ORGANIZATION_GUID   CHAR(38),
...
(
    PLATFORM_DATASOURCES_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    DATAGENTYPE_ID          CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    DATABUILD_DATAATTRIBUTE_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    DATABUILD_DATAATTRIBUTE_DTL_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    DATABUILD_DATASTRUCTURES_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
    DATABUILD_DESCRIPTION       VARCHAR(65),
    DEFINITION                  VARCHAR(255),
...
(
    RULE_ID         CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    RULESET_DEFINITIONS_ID   CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
...
(
    PLATFORM_TOKENS_XMAP_ID CHAR(38) PRIMARY KEY DEFAULT (UPPER(HEX(RANDOMBLOB(16)))),
    DATASTRUCTURE_ID        CHAR(38),
