...
(
    TERMCODESET_ID CHAR(38) PRIMARY KEY DEFAULT (LOWER(HEX(RANDOMBLOB(16)))),
    MAINTAINED_DATE   VARCHAR(20) DEFAULT (DATETIME('NOW', 'LOCALTIME')),
    STATUS_ID      VARCHAR(10) DEFAULT 'Active',
    CUI            VARCHAR(8) NULL,
    LAT            VARCHAR(3) NULL,
...
(
    ...
    DATAATTRIBUTE_ID               CHAR(38),
    MAINTAINED_DATE                VARCHAR(20) (DATETIME('NOW', 'LOCALTIME')),
    EXPIRATION_DATE            VARCHAR(20) DEFAULT (DATETIME('NOW', '+1 years')),
...
(
    ...
    DATABUILD_DATASTRUCTURES_ID     CHAR(38),
    DATAATTRIBUTE_ID                CHAR(38),
    ...
    STATUS_ID                       VARCHAR(10) DEFAULT 'Active',
    CREATED_USER                    VARCHAR(20) DEFAULT 'Platform',
    FOREIGN KEY (DATABUILD_DATASTRUCTURES_ID) REFERENCES PLATFORM_DATABUILDING_DATASTRUCTURES (DATABUILD_DATASTRUCTURES_ID),
    FOREIGN KEY (PARAM_OPERATOR) REFERENCES REFDATA_OPERATIONTYPES (OPERATIONTYPE_ID),
    FOREIGN KEY (STATUS_ID) REFERENCES REFDATA_STATUS (STATUS_ID),
    FOREIGN KEY (SENSITIVITYFLAG_ID) REFERENCES REFDATA_SENSITIVITYFLAGS (SENSITIVITYFLAG_ID),
    FOREIGN KEY (DATAATTRIBUTE_ID) REFERENCES REFDATA_DATAATTRIBUTES (DATAATTRIBUTE_ID)
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_UINDEX
    ON DATATIER_SDP_DATAATTRIBUTES (DATATIER_ID, BASEVALUE, SUPPORTINGVALUE1, SUPPORTINGVALUE2, SUPPORTINGVALUE3,
                                    SUPPORTINGVALUE4, SUPPORTINGVALUE5, SUPPORTINGVALUE6, SUPPORTINGVALUE7, MAINTAINED_DATE,
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_INDX ON DATATIER_SDP_DATAATTRIBUTES
    (
     ...
     SUPPORTINGVALUE5 ASC, SUPPORTINGVALUE6 ASC, SUPPORTINGVALUE7 ASC, MAINTAINED_DATE ASC,
