...
(
    ...
    DATASTRUCTURE_DETAILS VARCHAR(256),
    CREATED_DATE          VARCHAR(20)        DEFAULT (DATETIME('NOW', 'LOCALTIME')),
    CREATED_USER          VARCHAR(20) DEFAULT 'Platform',
    STATUS_ID             VARCHAR(10) DEFAULT 'Active',
    REGISTEREDAPP_GUID    VARCHAR(38),
...
(
    SDP_DATAATTRIBUTE_METADATA_ID INTEGER PRIMARY KEY AUTOINCREMENT,
...
(
    ...
    DATAATTRIBUTE_ID               CHAR(38),
    CREATED_DATE                VARCHAR(20) (DATETIME('NOW', 'LOCALTIME')),
     EXPIRATION_DATE            VARCHAR(20) DEFAULT (DATETIME('NOW', '+1 years')),
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_UINDEX
    ON DATATIER_SDP_DATAATTRIBUTES (DATATIER_ID, BASEVALUE, SUPPORTINGVALUE1, SUPPORTINGVALUE2, SUPPORTINGVALUE3,
                                    SUPPORTINGVALUE4, SUPPORTINGVALUE5, SUPPORTINGVALUE6, SUPPORTINGVALUE7, CREATED_DATE,
                                    DATAATTRIBUTE_ID, STATUS_ID, CREATED_USER, REGISTEREDAPP_GUID);

DROP INDEX IF EXISTS DATATIER_CRAWLER_INDX;
CREATE INDEX DATATIER_CRAWLER_INDX ON DATATIER_CRAWLERS
    ( DATACRAWLER_ID ASC, TOKEN ASC, CREATED_DATE ASC, STATUS_ID ASC, REGISTEREDAPP_GUID ASC, ORGANIZATION_GUID ASC )
...
CREATE INDEX DATATIER_SDP_DATAATTRIBUTES_INDX ON DATATIER_SDP_DATAATTRIBUTES
    (
     DATATIER_ID ASC, BASEVALUE ASC,
     SUPPORTINGVALUE1 ASC, SUPPORTINGVALUE2 ASC, SUPPORTINGVALUE3 ASC, SUPPORTINGVALUE4 ASC,
     SUPPORTINGVALUE5 ASC, SUPPORTINGVALUE6 ASC, SUPPORTINGVALUE7 ASC, CREATED_DATE ASC,
     STATUS_ID ASC, DATAATTRIBUTE_ID ASC, CREATED_USER ASC, REGISTEREDAPP_GUID ASC);
...
CREATE INDEX DATATIER_SDP_DATASTRUCTURES_INDEX ON DATATIER_SDP_DATASTRUCTURES
    ( DATASTRUCTURE_CORE_ID ASC, DATASTRUCTURE_NAME ASC, CREATED_DATE ASC, STATUS_ID ASC, REGISTEREDAPP_GUID ASC );
...
CREATE INDEX PLATFORM_CODESETS_INDUSTRYSTDS_INDX ON PLATFORM_CODESETS_INDUSTRYSTDS
    ( TERMCODESET_ID ASC, CREATED_DATE ASC, STATUS_ID ASC, CUI ASC,
